...
/**
 * Responsável por toda comunicação com a API TVMaze.
 * Faz requisições HTTP e converte o JSON em objetos Java.
 */
public class ApiTVMaze {
    ...
    /**
     * Faz a requisição HTTP e retorna a resposta como String.
     * Método reutilizável para qualquer endpoint da API.
     */
